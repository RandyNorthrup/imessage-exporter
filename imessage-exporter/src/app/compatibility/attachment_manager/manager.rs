...
impl AttachmentManager {
    pub fn from(mode: AttachmentManagerMode) -> Self {
        // Only probe for the converters a given mode can actually use, so modes
        // that never convert (Disabled/Clone) don't shell out to detect ffmpeg,
        // ImageMagick, or a hardware encoder.
        match mode {
